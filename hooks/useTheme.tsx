...
const lightColors: ColorScheme = {
  ...
  border: "#e2e8f0",
  primary: "#3b82f6",
  success: "#22c55e", // More vibrant green
  warning: "#f59e0b",
  danger: "#e11d48", // More bold and modern red-pink
  shadow: "#000000",
  gradients: {
    background: ["#f8fafc", "#e2e8f0"],
    surface: ["#ffffff", "#f8fafc"],
    primary: ["#3b82f6", "#1d4ed8"],
    success: ["#22c55e", "#16a34a"], // Green gradient
    warning: ["#f59e0b", "#d97706"],
    danger: ["#e11d48", "#be123c"], // Reddish-pink gradient
    muted: ["#9ca3af", "#6b7280"],
    empty: ["#f3f4f6", "#e5e7eb"],
  },
  backgrounds: {
